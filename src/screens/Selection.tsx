...
//             >
//                 <SeatMap />
//                 <View style={{ borderWidth: 0, justifyContent: 'flex-end', flexDirection: 'row', top: 60 }}>
//                     <ZoomControls />
//                 </View>
...
//                     <Detail />
//                     <SeatSelectionInfo />
//                     <View style={{ top: 0, borderWidth: 0, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
//                         <View style={styles.rowInfo}>
//                             <View style={{ justifyContent: 'center', alignItems: 'flex-start', borderWidth: 0 }}>
...
//                         >
//                             <Text style={styles.selectSeatsText}>Proceed To pay</Text>
//                         </TouchableOpacity>
//                     </View>
//                 </View>
//             </View>
